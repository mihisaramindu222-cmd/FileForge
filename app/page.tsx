...
export default function Home() {
  ...
  return <main>
    ...
    <footer className="site-footer"><div className="shell footer-inner"><span>© {new Date().getFullYear()} FileForge</span><span>Private PDF compression and practical file conversion.</span><span><a href="/privacy">Privacy</a> · <a href="/terms">Terms</a> · <a href={`mailto:${process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'support@example.com'}`}>Support</a></span></div></footer>
  </main>;
}
